            ...
            if hc_res_clinical_impression.subject_type == 'patient':
                ...
                if hc_res_clinical_impression.subject_patient_id.birth_date:
                    subject_patient_birth_date = datetime.strftime(
                        datetime.strptime(hc_res_clinical_impression.subject_patient_id.birth_date, DF), "%Y-%m-%d")
    ...
    def _compute_effective_name(self):
        for hc_res_clinical_impression in self:
            if hc_res_clinical_impression.effective_type == 'datetime':
                ...
                hc_res_clinical_impression.effective_name = 'Between' + str(
                    hc_res_clinical_impression.effective_start_date) + ' and ' + str(
                    hc_res_clinical_impression.effective_end_date)
