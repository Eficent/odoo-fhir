...
class HumanName(models.Model):
    ...
    #
    @api.depends('display_order', 'prefix_ids', 'first_id', 'middle_ids', 'initial_ids', 'nickname_ids',
                 'mother_maiden_id', 'surname_id', 'suffix_ids', 'previous_surname_ids', 'birth_surname_id')
    def _compute_full_name(self):
        ...
        previous_surname = " ".join([previous_surname.name for previous_surname in
                                     self.previous_surname_ids]) if self.previous_surname_ids else ''
