...
class ElementDefinition(models.Model):
    ...
    fixed_base_64_binary = fields.Float(string="Fixed Base 64 Binary",
    ...
    fixed_codeable_concept = fields.Float(string="Fixed Codeable Concept",
    ...
    fixed_quantity_uom_id = fields.Many2one(comodel_name="product.uom", string="Fixed Quantity UOM",
                                            help="Quantity unit of measure.")
    fixed_range = fields.Float(string="Fixed Range", help="Range value must be exactly this.")
    fixed_range_uom_id = fields.Many2one(comodel_name="product.uom", string="Fixed Range UOM",
                                         help="Range unit of measure.")
    fixed_period = fields.Float(string="Fixed Period", help="Period value must be exactly this.")
    fixed_period_uom_id = fields.Many2one(comodel_name="product.uom", string="Fixed Period UOM",
                                          help="Period unit of measure.")
    fixed_ratio = fields.Float(string="Fixed Ratio", help="Ratio value must be exactly this.")
    fixed_ratio_uom_id = fields.Many2one(comodel_name="product.uom", string="Fixed Ratio UOM",
                                         help="Ratio unit of measure.")
    ...
    pattern_name = fields.Char(string="Pattern", compute="_compute_pattern_name", store="True",
                               help="Value must have at least these property values.")
    pattern_integer = fields.Float(string="Pattern Integer",
                                   help="Integer value must have at least these property values.")
    pattern_decimal = fields.Float(string="Pattern Decimal",
                                   help="Decimal value must have at least these property values.")
    pattern_date_time = fields.Float(string="Pattern Date Time",
    ...
    pattern_instant = fields.Float(string="Pattern Instant",
                                   help="Instant value must have at least these property values.")
    pattern_string = fields.Float(string="Pattern String",
    ...
    pattern_boolean = fields.Float(string="Pattern Boolean",
    ...
    pattern_markdown = fields.Float(string="Pattern Markdown",
                                    help="Markdown value must have at least these property values.")
    pattern_base_64_binary = fields.Float(string="Pattern Base 64 Binary",
                                          help="Base 64 Binary value must have at least these property values.")
    pattern_coding = fields.Float(string="Pattern Coding",
                                  help="Coding value must have at least these property values.")
    pattern_codeable_concept = fields.Float(string="Pattern Codeable Concept",
                                            help="Codeable Concept value must have at least these property values.")
    pattern_attachment = fields.Float(string="Pattern Attachment",
                                      help="Attachment value must have at least these property values.")
    pattern_identifier = fields.Float(string="Pattern Identifier",
                                      help="Identifier value must have at least these property values.")
    pattern_quantity = fields.Float(string="Pattern Quantity",
                                    help="Quantity value must have at least these property values.")
    pattern_quantity_uom_id = fields.Many2one(comodel_name="product.uom", string="Pattern Quantity UOM",
                                              help="Quantity unit of measure.")
    pattern_range = fields.Float(string="Pattern Range", help="Range value must have at least these property values.")
    pattern_range_uom_id = fields.Many2one(comodel_name="product.uom", string="Pattern Range UOM",
                                           help="Range unit of measure.")
    pattern_period = fields.Float(string="Pattern Period",
                                  help="Period value must have at least these property values.")
    pattern_period_uom_id = fields.Many2one(comodel_name="product.uom", string="Pattern Period UOM",
                                            help="Period unit of measure.")
    pattern_ratio = fields.Float(string="Pattern Ratio", help="Ratio value must have at least these property values.")
    pattern_ratio_uom_id = fields.Many2one(comodel_name="product.uom", string="Pattern Ratio UOM",
                                           help="Ratio unit of measure.")
    pattern_human_name = fields.Float(string="Pattern Human Name",
                                      help="Human Name value must have at least these property values.")
    pattern_address = fields.Float(string="Pattern Address",
                                   help="Address value must have at least these property values.")
    pattern_contact_point = fields.Float(string="Pattern Contact Point",
                                         help="Contact Point value must have at least these property values.")
    pattern_timing = fields.Float(string="Pattern Timing",
                                  help="Timing value must have at least these property values.")
    pattern_signature = fields.Float(string="Pattern Signature",
                                     help="Signature value must have at least these property values.")
    pattern_reference = fields.Float(string="Pattern Reference",
    ...
    example_name = fields.Char(string="Example", compute="_compute_example_name", store="True",
    ...
    example_base_64_binary = fields.Float(string="Example Base 64 Binary",
    ...
    example_codeable_concept = fields.Float(string="Example Codeable Concept",
                                            help="Codeable Concept example value (as defined for type).")
    example_attachment = fields.Float(string="Example Attachment",
                                      help="Attachment example value (as defined for type).")
    example_identifier = fields.Float(string="Example Identifier",
    ...
    example_quantity_uom_id = fields.Many2one(comodel_name="product.uom", string="Example Quantity UOM",
                                              help="Quantity unit of measure.")
    example_range = fields.Float(string="Example Range", help="Range example value (as defined for type).")
    example_range_uom_id = fields.Many2one(comodel_name="product.uom", string="Example Range UOM",
                                           help="Range unit of measure.")
    example_period = fields.Float(string="Example Period", help="Period example value (as defined for type).")
    example_period_uom_id = fields.Many2one(comodel_name="product.uom", string="Example Period UOM",
                                            help="Period unit of measure.")
    example_ratio = fields.Float(string="Example Ratio", help="Ratio example value (as defined for type).")
    example_ratio_uom_id = fields.Many2one(comodel_name="product.uom", string="Example Ratio UOM",
                                           help="Ratio unit of measure.")
    example_human_name = fields.Float(string="Example Human Name",
    ...
    example_contact_point = fields.Float(string="Example Contact Point",
