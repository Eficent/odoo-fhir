    ...
    def _compute_name(self):
        ...
        for hc_res_procedure in self:
            if hc_res_procedure.subject_type == 'patient':
                ...
                if hc_res_procedure.subject_patient_id.birth_date:
                    subject_patient_birth_date = datetime.strftime(
                        datetime.strptime(hc_res_procedure.subject_patient_id.birth_date, DF), "%Y-%m-%d")
            ...
            if hc_res_procedure.performed_date_type == 'date_time':
                performed_date = datetime.strftime(datetime.strptime(hc_res_procedure.performed_datetime, DTF),
                                                   "%Y-%m-%d")
                comp_name = comp_name + " " + performed_date
            if hc_res_procedure.performed_date_type == 'period':
                performed_date = datetime.strftime(datetime.strptime(hc_res_procedure.performed_start_date, DTF),
                                                   "%Y-%m-%d")
                comp_name = comp_name + " " + performed_date
    ...
    def _compute_performed_date_name(self):
        for hc_res_procedure in self:
            if hc_res_procedure.performed_date_type == 'date_time':
                ...
                hc_res_procedure.performed_date_name = 'Between ' + str(
                    hc_res_procedure.performed_start_date) + ' and ' + str(hc_res_procedure.performed_end_date)
