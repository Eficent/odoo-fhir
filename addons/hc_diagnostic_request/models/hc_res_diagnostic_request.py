    ...
    def _compute_occurrence_name(self):
        for hc_res_diagnostic_report in self:
            if hc_res_diagnostic_report.occurrence_type == 'datetime':
                ...
                hc_res_diagnostic_report.occurrence_name = 'Between' + str(
                    hc_res_diagnostic_report.occurrence_start_date) + ' and ' + str(
                    hc_res_diagnostic_report.occurrence_end_date)
