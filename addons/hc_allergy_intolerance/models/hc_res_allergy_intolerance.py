        ...
        for hc_res_allergy_intolerance in self:
            if hc_res_allergy_intolerance.patient_id:
                ...
                if hc_res_allergy_intolerance.patient_id.birth_date:
                    patient_birth_date = datetime.strftime(
                        datetime.strptime(hc_res_allergy_intolerance.patient_id.birth_date, DF), "%Y-%m-%d")
            ...
            if hc_res_allergy_intolerance.asserted_date:
                patient_asserted_date = datetime.strftime(
                    datetime.strptime(hc_res_allergy_intolerance.asserted_date, DTF), "%Y-%m-%d")
    ...
    def _compute_onset_name(self):
        for hc_res_allergy_intolerance in self:
            if hc_res_allergy_intolerance.onset_type == 'date_time':
                ...
                hc_res_allergy_intolerance.onset_name = str(hc_res_allergy_intolerance.onset_age) + ' ' + str(
                    hc_res_allergy_intolerance.onset_age_uom_id.name) + "s old"
            elif hc_res_allergy_intolerance.onset_type == 'period':
                hc_res_allergy_intolerance.onset_name = 'Between ' + str(
                    hc_res_allergy_intolerance.onset_start_date) + ' and ' + str(
                    hc_res_allergy_intolerance.onset_end_date)
            elif hc_res_allergy_intolerance.onset_type == 'range':
                hc_res_allergy_intolerance.onset_name = 'Between ' + str(
                    hc_res_allergy_intolerance.onset_range_low) + ' and ' + str(
                    hc_res_allergy_intolerance.onset_range_high)
