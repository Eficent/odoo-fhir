    ...
    def _compute_value_name(self):
        for hc_questionnaire_response_item_answer in self:
            if hc_questionnaire_response_item_answer.value_type == 'boolean':
                hc_questionnaire_response_item_answer.value_name = str(
                    hc_questionnaire_response_item_answer.value_boolean)
            elif hc_questionnaire_response_item_answer.value_type == 'decimal':
                hc_questionnaire_response_item_answer.value_name = str(
                    hc_questionnaire_response_item_answer.value_decimal)
            elif hc_questionnaire_response_item_answer.value_type == 'integer':
                hc_questionnaire_response_item_answer.value_name = str(
                    hc_questionnaire_response_item_answer.value_integer)
                ...
                hc_questionnaire_response_item_answer.value_name = str(
                    hc_questionnaire_response_item_answer.value_datetime)
            elif hc_questionnaire_response_item_answer.value_type == 'instant':
                hc_questionnaire_response_item_answer.value_name = str(
                    hc_questionnaire_response_item_answer.value_instant)
                ...
                hc_questionnaire_response_item_answer.value_name = str(
                    hc_questionnaire_response_item_answer.value_quantity)
