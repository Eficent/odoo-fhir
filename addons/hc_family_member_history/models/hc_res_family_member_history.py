    ...
    def _compute_born_name(self):
        for hc_res_family_member_history in self:
            if hc_res_family_member_history.born_type == 'period':
                hc_res_family_member_history.born_name = 'Between' + str(
                    hc_res_family_member_history.earliest_born_date) + ' and ' + str(
                    hc_res_family_member_history.latest_born_date)
    ...
    def _compute_age_name(self):
        for hc_res_family_member_history in self:
            if hc_res_family_member_history.age_type == 'age':
                hc_res_family_member_history.age_name = str(
                    hc_res_family_member_history.age_age) + ' ' + hc_res_family_member_history.age_age_uom_id.name
            elif hc_res_family_member_history.age_type == 'range':
                hc_res_family_member_history.age_name = 'Between' + str(
                    hc_res_family_member_history.age_age_range_low) + ' and ' + str(
                    hc_res_family_member_history.age_age_range_high)
    ...
    def _compute_deceased_age_name(self):
        for hc_res_family_member_history in self:
            if hc_res_family_member_history.deceased_type == 'age':
                hc_res_family_member_history.deceased_name = str(
                    hc_res_family_member_history.deceased_age) + ' ' + hc_res_family_member_history.deceased_age_uom_id.name
            elif hc_res_family_member_history.deceased_type == 'range':
                hc_res_family_member_history.deceased_name = 'Between' + str(
                    hc_res_family_member_history.deceased_age_range_low) + ' and ' + str(
                    hc_res_family_member_history.deceased_age_range_high)
...
class FamilyMemberHistoryFamilyMemberHistoryReasonReference(models.Model):
    ...
    @api.multi
    @api.depends('reason_reference_condition_id', 'reason_reference_observation_id',
                 'reason_reference_allergy_intolerance_id', 'reason_reference_questionnaire_response_id')
